...
public abstract class CaramelFluid extends FlowableFluid {
	...
	public Fluid getStill() {
		return ModFluids.CARAMEL;
	}

	@Override
	public Fluid getFlowing() {
		return ModFluids.CARAMEL_FLOWING;
	}
	...
	public BlockState toBlockState(FluidState state) {
		return ModFluids.CARAMEL_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
	}
